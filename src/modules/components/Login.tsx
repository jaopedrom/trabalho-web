...
export default function Login() {
    ...
    const onSubmit: SubmitHandler<LoginFormInputs> = (data) => {
        ...
        //busca de hospede no mock de dados com base no cpf e senha
        const usuarioEncontrado = hospedesMock.find((hospedesMock) =>
            hospedesMock.cpf === data.cpf && hospedesMock.senha === data.senha);

        if (usuarioEncontrado) {
            localStorage.setItem("usuario encontrado", JSON.stringify(usuarioEncontrado));
        } else {
