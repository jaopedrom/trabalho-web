    ...
    return (
        <NavigationMenu.Root className="bg-gray-50 rounded-lg p-1 text-gray-900 min-w-max">
            <NavigationMenu.List className="flex relative list-none p-0 m-0">
                <NavigationMenu.Item>
                    <Link className="box-border flex items-center justify-center gap-1.5 h-10 px-3.5 m-0 outline-none border-none rounded-md
                    bg-gray-50 text-base font-normal leading-6 text-gray-900 select-none no-underline max-sm:text-[0.925rem] max-sm:px-2
                    hover:bg-gray-100 data-popup-open:bg-gray-100 focus-visible:outline-2 focus-visible:outline-blue-500 focus-visible:-outline-offset-1"
                          href="/">
                        Home
                    </Link>
                </NavigationMenu.Item>
