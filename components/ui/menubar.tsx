...
function Menubar({ className, ...props }: MenubarPrimitive.Props) {
  return (
    <MenubarPrimitive
      data-slot="menubar"
      className={cn(
        "flex flex-col h-auto items-stretch gap-1 rounded-none border p-2",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "flex w-full justify-between items-center rounded-none px-2 py-2 text-sm font-medium outline-hidden select-none hover:bg-muted aria-expanded:bg-muted",
        className
      )}
      {...props}
    />
